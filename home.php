        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <small class="text-light"><i class="fa fa-envelope-open me-2"></i><?php echo $_SESSION['technical']['email'] ?></small>
                </div>
            </div>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn"><?php echo $_SESSION['technical']['type_of'] ?></h1>
                ...
                <div class="col-lg-4">
                    <div class="row g-5">
                        <div class="col-12 wow zoomIn" data-wow-delay="0.2s">
                            ...
                            <h4>سوف تصل الي العميل في اسرع وقت</h4>
                            <p class="mb-0">حاول ان تجعل العملاء سعاداء</p>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="row g-5">
                        <div class="col-12 wow zoomIn" data-wow-delay="0.4s">
                            ...
                            <p class="mb-0">يتم التواصل مع العميل لمعرفة طلبه بالتفاصيل و نجعله يتواصل معك</p>
                        </div>
